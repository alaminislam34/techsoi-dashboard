...
const UpdateCategoryFrom = () => {
  return (
    <div className="p-8 bg-white space-y-10 font-sans">
      {/* --- Create Main Category Section --- */}
      <section>
        <div className="grid grid-cols-12 gap-4 items-end">
          <div className="col-span-7">
            <label className="block text-lg text-dark mb-2">
          ...
          <div className="col-span-3">
            <label className="block text-lg text-dark mb-2">Upload icon</label>
      ...
      {/* --- Add Brands Section --- */}
      <section>
        <label className="block text-lg text-dark mb-2">Add Brands</label>
        <div className="grid grid-cols-12 gap-4 items-end">
